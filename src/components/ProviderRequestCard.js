...
export default function CustomerRequestCard({ request = {}, relationStatus = '', navigation }) {
  const {
        ...
        >
          ...
          {tags.length > 0 && (
            <FlatList
              ...
              renderItem={({ item }) => (
                <LinearGradient colors={['#D1FAE5', '#6EE7B7']} style={styles.tag}>
          ...
          {skills.length > 0 && (
            <FlatList
              ...
              keyExtractor={(item, idx) => idx.toString()}
              renderItem={({ item }) => (
                <LinearGradient colors={['#E0F2FE', '#90CDF4']} style={styles.skill}>
          ...
          <View style={styles.actionsRow}>
            ...
            // if (request.providerHasSentOffer) return;
